...
```
Decision 2 ～ 8                     = 未决
producer ownership（artifact ／ package ／ manifest ／ provenance metadata producer） = OPEN（Decision 2）
